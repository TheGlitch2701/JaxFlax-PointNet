...
parser.add_argument('--log_dir', default='log_basic', help='Log dir [default: log]')
parser.add_argument('--num_point', type=int, default=1024, help='Point Number [256/512/1024/2048] [default: 1024]') # default = 1024
parser.add_argument('--max_epoch', type=int, default=50, help='Epoch to run [default: 250]') # default = 250
...
def train():
    with tf.Graph().as_default():
        ...
        for epoch in range(MAX_EPOCH):
            ...
            log_string("Time for EPOCH %03d: %f" % (epoch, time.time() - start_epoch))
...
if __name__ == "__main__":
    start = time.time()
    train()
    log_string("Total Training Time: %f" % (time.time() - start))
    LOG_FOUT.close()
